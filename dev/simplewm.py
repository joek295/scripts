'''
simplewm.py, by Joshua D. Bartlett, March 2011

I hereby release this code into the public domain.

This is intended to demo the simplest useful WM I can imagine.
I used PLWM as a reference to figure out how this Xlib stuff was done.
